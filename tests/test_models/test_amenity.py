...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_datetime_format(self):
        ...
        self.assertEqual(datetime.strptime(model_dict['created_at'], expected_format), self.amenity.created_at)
        self.assertEqual(datetime.strptime(model_dict['updated_at'], expected_format), self.amenity.updated_at)
